...
//     const blogs = await Blog.find({ published: true }); // Fetch published blog posts
...
//   </url>
//   <url>
//     <loc>${CLIENT_URL}/login</loc>
//     <lastmod>${new Date().toISOString()}</lastmod>
//     <changefreq>monthly</changefreq>
//     <priority>0.6</priority>
//   </url>
//   <url>
//     <loc>${CLIENT_URL}/signup</loc>
//     <lastmod>${new Date().toISOString()}</lastmod>
//     <changefreq>monthly</changefreq>
//     <priority>0.6</priority>
//   </url>
...
//       sitemap += `
//   <url>
//     <loc>${CLIENT_URL}/prompt/${prompt._id}</loc>
...
//       sitemap += `
//   <url>
//     <loc>${CLIENT_URL}/blog/${blog._id}</loc>
