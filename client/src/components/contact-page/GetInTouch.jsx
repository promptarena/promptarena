...
//   return (
//     <div className="min-h-screen container mx-auto bg-gradient-to-br from-purple-900/30 via-purple-700/50 to-[#030303] text-white font-sans p-8">
...
//         {/* Form Section with Staggered Animation */}
//         <motion.div
//           className="bg-[#12121A]/40 backdrop-blur-3xl ring-1 ring-neutral-500 rounded-3xl p-8 shadow-[5px_5px_0px_0px_rgba(109,40,217)] flex"
//           initial={{ opacity: 0 }}
//           animate={{ opacity: 1 }}
//           transition={{ duration: 0.8, delay: 0.4 }}
//         >
...
//                 {isLoading ? (
//                   <span className="text-white gap-5 flex-center">
//                     <Loader2 className="w-5 h-5 animate-spin" /> sending it to
//                     the moon...!
//                   </span>
//                 ) : (
//                   <span className="text-white gap-5 flex-center">
//                     Send it to the moon <ArrowRight className="w-5 h-5" />
//                   </span>
//                 )}
//               </motion.button>
//             </motion.form>
...
//           {/* Parallax Image Section */}
//           <div className="flex-1 relative rounded-2xl shadow-[0_0_10px_rgba(0,0,0,0.5)] overflow-hidden w-full">
//             <motion.div
//               className="absolute inset-0 bg-gradient-to-t from-[#12121A] to-transparent z-10"
//               initial={{ opacity: 0 }}
//               animate={{ opacity: 0.8 }}
