...
// const ExploreTopHead = () => {
//   return (
//     <div className="relative w-full  h-[300px] bg-gradient-to-b from-[#1a0b2e] to-[#2d1b4e] overflow-hidden">
//       {/* Glowing Dots */}
...
//         className="absolute inset-0 flex items-center justify-center"
//       >
//         <h1 className="h1 font-bold text-white text-shadow font-share-tech-mono tracking-wider">
//           Explore Our Prompts
//         </h1>
//       </motion.div>
//     </div>
